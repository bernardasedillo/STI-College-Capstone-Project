			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="alert alert-info">Settings</div>
					    <a href="manage_content.php" class="btn btn-info">Manage Website Content</a>
					    <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'Super Admin') { ?>
						<a href="account.php" class="btn btn-info">Account</a>
						<a href="ActivityLogs.php" class="btn btn-info">Activity Logs</a>
						<a href="Backup and Restore.php" class="btn btn-info">Backup & Restore</a>
					    <?php } ?>				
					</div>
			</div>
		</div>
